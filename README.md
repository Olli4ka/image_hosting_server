...
![img_one.png](src/static/img/img_one.png)
...
![img_two.png](src/static/img/img_two.png)
...
```bash
git clone git@github.com:Olli4ka/image_hosting_server.git
...
DB_PORT=5432
BACKUP_DIR=./backups
DB_CONTAINER_NAME=image_hosting_server-db-1
```
